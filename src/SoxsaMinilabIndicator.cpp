...
SoxsaMinilabIndicatorWidget::SoxsaMinilabIndicatorWidget(SoxsaMinilabIndicator *module) {
    ...
    //Text Fields
	float text_left[SoxsaMinilabIndicator::NUM_TEXTFIELDS]  = {5, 300,  5,300};
	float text_top[SoxsaMinilabIndicator::NUM_TEXTFIELDS]   = {90, 90,190,190};
